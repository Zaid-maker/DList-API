  ...
  sendJoinMessage(guild: Guild) {
    return guild.systemChannel?.send(
      new MessageEmbed({
        ...
        fields: [
          {
            name: ":rocket: Check out your server listing...",
            value: `${config.dashboardURL}/servers/${guild.id}`,
          },
          {
            name: ":art: Customize it at...",
            value: `${config.dashboardURL}/dashboard/servers/${guild.id}/edit`,
          },
        ],
